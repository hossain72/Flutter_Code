...
class Pages {
  ...
  static Future<dynamic>? goToRouts(
    BuildContext context,
    String route, {
    dynamic arguments,
  }) async {
    ...
    return await Navigator.pushNamed(context, route, arguments: arguments).then(
      (value) {
  ...
  static dynamic goBack<T extends Object?>(BuildContext context, [T? result]) {
    ...
    if (Navigator.canPop(context)) {
      ...
      debugPrint('Cannot pop - no routes to pop');
    }
  }
  ...
  static Future<dynamic>? goToAndKeepRoute(
    ...
    routeManager.addRoute(goesToRoute);
    return await Navigator.pushNamedAndRemoveUntil(context, goesToRoute, (
      Route<dynamic> route,
    ) {
